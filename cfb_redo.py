...
# f = open(r'C:\Users\J72336\Downloads\data.txt','w')
# f.write(data.text)
# f.close

# g = open(r'C:\Users\J72336\Downloads\teams.txt','w')
# g.write(team_info.text)
# g.close

# f = open(r'C:\Users\J72336\Downloads\data.txt','r')
# data = f.read()
# f.close

# g = open(r'C:\Users\J72336\Downloads\teams.txt','r')
# team_info = g.read()
# g.close
